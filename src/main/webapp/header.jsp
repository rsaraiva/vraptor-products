...
<body>
   <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
         <div class="container">
            <a id="brandLink" href="<c:url value='/'/>" class="brand">Vraptor-products</a>
   ...
   <div class="container forgecontainer">
      <div id="navigation">
         ...
         <ul>
            <li><a href="<c:url value="/category/search"/>">Category</a></li><li><a href="<c:url value="/product/search"/>">Product</a></li>
         </ul>
